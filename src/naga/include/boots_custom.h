...
#define CNT_CUSTOM \
    ...
    ACL_RADIUSPUSH_PKTS, \
    ACL_RADIUSPUSH_DROP, \
    ACL_RADIUSPUSH_PARA_ERROR,\
    ACL_RADIUSPUSH_SET, \
    ACL_RADIUSPUSH_DEL, \
    ACL_RADIUSPUSH_PIPE_ERROR,\
    ACL_RADIUSPUSH_EXEC_ERROR,\
    ACL_RADIUSPUSH_TX_SUCCESS,\
    \
    /* Max of counter */ \
    NAGA_CNT_MAX
...
#define CNT_DEF_CUSTOM \
    ...
    CNT_DEF(ACL_RADIUSPUSH_PKTS),\
    CNT_DEF(ACL_RADIUSPUSH_DROP),\
    CNT_DEF(ACL_RADIUSPUSH_PARA_ERROR),\
    CNT_DEF(ACL_RADIUSPUSH_SET), \
    CNT_DEF(ACL_RADIUSPUSH_DEL), \
    CNT_DEF(ACL_RADIUSPUSH_PIPE_ERROR),\
    CNT_DEF(ACL_RADIUSPUSH_EXEC_ERROR),\
    CNT_DEF(ACL_RADIUSPUSH_TX_SUCCESS),\
    \
    /* Max of counter */ \
