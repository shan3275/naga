/* $Id: //depot/main/NetXtreme/drivers/linux/tg3-new/tg3.h#105 $
...
#define PBUF_OFF_FORMAT(_type, _ptr, _p,_len) (_ptr = (_type)((char *)_p->ptr)-_len)
#define PBUF_ON_FORMAT(_type, _ptr, _p,_len) (_ptr = (_type)((char *)_p->ptr)+_len)
...
#define PRINTF_PKT(_p) \
    do{ \
         int _i; \
         for(_i=0; _i<_p->len; _i++)\
         {\
            if(_i%16==0)\
            {\
                printk("\n");\
            }\
            printk("%02x ", *((uint8_t *)_p->ptr + _i) );\
         }\
         printk("\n");\
     }while(0)
