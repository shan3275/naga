...
#define CNT_CUSTOM \
    ...
    ACL_WBPUSH_PKTS, \
    ACL_WBPUSH_DROP_GET_OR_POST, \
    ACL_WBPUSH_FAIL, \
    ACL_WBPUSH_PAYLOAD_GEN,\
    ACL_WBPUSH_DROP_HEAD_GEN1,\
    ACL_WBPUSH_RAW_UDP_GEN,\
    ACL_WBPUSH_DROP_SEND_PACKET,\
    ACL_WBPUSH_TX_SUCCESS,\
    \
    /* Max of counter */ \
    NAGA_CNT_MAX
...
#define CNT_DEF_CUSTOM \
    ...
    CNT_DEF(URL_URLPUSH_APPID_DSID), \
    ...
    CNT_DEF(ACL_WBPUSH_PKTS), \
    CNT_DEF(ACL_WBPUSH_DROP_GET_OR_POST), \
    CNT_DEF(ACL_WBPUSH_FAIL), \
    CNT_DEF(ACL_WBPUSH_PAYLOAD_GEN),\
    CNT_DEF(ACL_WBPUSH_DROP_HEAD_GEN1),\
    CNT_DEF(ACL_WBPUSH_RAW_UDP_GEN),\
    CNT_DEF(ACL_WBPUSH_DROP_SEND_PACKET),\
    CNT_DEF(ACL_WBPUSH_TX_SUCCESS),\
    \
    /* Max of counter */ \
